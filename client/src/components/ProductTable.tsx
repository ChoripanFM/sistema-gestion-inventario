...
import { ImageOff, Pencil, Trash2, Eye } from "lucide-react";
              ...
              return (
                ...
                >
                  ...
                  <td className="px-2 py-3">
                    <div className="relative group w-10 h-10 rounded-lg bg-bg border border-line flex items-center justify-center overflow-hidden shrink-0">
                      {product.image ? (
                        <>
                          <img
